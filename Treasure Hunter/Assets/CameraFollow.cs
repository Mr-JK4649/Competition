...
public class CameraFollow : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (FixedCamera){
            ...
            this.gameObject.GetComponent<Transform>().position = new Vector3(pms.Origin_Pos.x, pms.Origin_Pos.y + 4.5f, pl.position.z - 11.5f);
        }
        else {
            this.gameObject.GetComponent<Transform>().position = new Vector3(pl.position.x, pl.position.y + 4.5f, pl.position.z - 11.5f);
        }
